const projectsData = [
  ...
  {
    title: 'Veldeva (Banjarmasin, Indonesia)',
  ...
  {
    title: 'WLS Booking System (Banjarmasin, Indonesia)',
  ...
  {
    title: 'Eligibilty Checking (Lucknow, India)',
  ...
  {
    title: 'PEDEVE ERP (Jakarta, Indonesia)',
  ...
  {
    title: 'Open Journal System (Jakarta, Indonesia)',
